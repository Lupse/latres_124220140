...
class BlogsDetailScreen extends StatefulWidget {
  final String id;
  const BlogsDetailScreen({super.key, required this.id});

  @override
  State<BlogsDetailScreen> createState() => _NewsDetailScreenState();
}

class _NewsDetailScreenState extends State<BlogsDetailScreen> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: FutureBuilder<Articles>(
          future: apiService.fetchBlogsDetail(widget.id),
